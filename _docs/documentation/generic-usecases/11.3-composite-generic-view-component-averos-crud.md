...
These menu entries could be rearranged and styled using the [averos menu configuration]({{"http://localhost:4000/averos/documentation/averos-menu-description/" | relative_url}} "averos menu configuration") process described in this documentation.
{: .notice--warning}