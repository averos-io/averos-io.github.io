...
- leverage `averos designer` capabilities for no-code application development by installing [Averos Designer](https://appbuilder.wiforge.com/averos-designer/) application either on mobile or on desktop devices
- and much more...
