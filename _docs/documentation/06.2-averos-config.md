...
**AverosConfig** is one implementation of **FrameworkConfiguration** that declares a list of supported languages. This list could be updated either manually or using the averos translation workflows `ng g @averos/workflow:add-language`. <br/>
