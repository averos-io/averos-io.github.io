...
permalink: /averos/documentation/customize-your-app-averos-workflow/
...
>🚩 These class members are generated by the averos crud creation  workflow and could obviously be updated by other members, modified or deleted at you convenience. Please refer to [**averos entity**]({{ "/averos/documentation/reference-averos-entity/" | relative_url }}, "Averos Entity") section for further details.
{: .notice--warning}
  ...
  - **An entity service** having the default api URL : 
    ...
    Please refer to the [**averos service**]({{ "/averos/documentation/reference-averos-service/" | relative_url }}, "Averos Service") section for further details.
    {: .notice--info}
