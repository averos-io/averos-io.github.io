...
🔖 Please note that, since this tutorial is dedicated to developers, we have not mentioned [**`averos designer`**](https://appbuilder.wiforge.com/averos-designer/ "averos designer") for **nocode** application development.<br/>
